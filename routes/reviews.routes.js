...
router.get('/reviews', authMiddleware, (req, res) => baseReviewController.getAll(req, res));
router.get('/reviews/:id', authMiddleware, (req, res) => baseReviewController.getOne(req, res));
